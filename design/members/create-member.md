...
|---|---|---|---|
| 1 | memberCode | Textbox | Bắt buộc; tối đa 20 ký tự; không trùng |
...
| 5 | dateOfBirth | Date picker | Không bắt buộc; ngày hợp lệ |
| 6 | address | Textarea | Không bắt buộc; tối đa 500 ký tự |
| 7 | status | Dropdown chọn một | Mặc định Đang hoạt động |
| 8 | saveButton | Button | Kiểm tra và lưu dữ liệu |
| 9 | cancelButton | Button | Đóng màn hình, không lưu |
