...
|---|---|---|---|
| 1 | Mã sách | Textbox | Bắt buộc; tối đa 20 ký tự; không trùng |
| 2 | Tên sách | Textbox | Bắt buộc; tối đa 200 ký tự |
| 3 | Loại sách | Dropdown chọn một | Bắt buộc; chọn từ danh mục Loại sách đang dùng |
| 4 | Tác giả | Dropdown chọn nhiều | Bắt buộc; chọn từ danh mục Tác giả đang dùng |
| 5 | Nhà xuất bản | Dropdown chọn một | Bắt buộc; chọn từ danh mục Nhà xuất bản đang dùng |
| 6 | Năm xuất bản | Textbox số | Không bắt buộc; từ 1900 đến năm hiện tại |
| 7 | Số lượng tổng | Textbox số | Bắt buộc; số nguyên > 0 |
| 8 | Vị trí kệ | Textbox | Không bắt buộc; tối đa 50 ký tự |
| 9 | Trạng thái | Dropdown chọn một | Mặc định Đang dùng |
| 10 | Lưu | Button | Kiểm tra và lưu dữ liệu |
| 11 | Hủy | Button | Đóng màn hình, không lưu |
