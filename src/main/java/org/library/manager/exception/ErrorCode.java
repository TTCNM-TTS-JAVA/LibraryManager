...
public enum ErrorCode {
    ...
    BOOK_CATEGORY_CANNOT_DELETE(4093, "book-category.cannot.delete", HttpStatus.CONFLICT),
    ...
    PUBLISHER_CANNOT_DELETE(4093, "publisher.can,not.delete", HttpStatus.CONFLICT);
